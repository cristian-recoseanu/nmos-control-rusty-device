...
[![Build Checks](https://github.com/cristian-recoseanu/nmos-control-rusty-device/actions/workflows/build_checks.yml/badge.svg)](https://github.com/cristian-recoseanu/nmos-control-rusty-device/actions/workflows/build_checks.yml)
[![API Testing](https://github.com/cristian-recoseanu/nmos-control-rusty-device/actions/workflows/api_testing.yml/badge.svg)](https://github.com/cristian-recoseanu/nmos-control-rusty-device/actions/workflows/api_testing.yml)
